        ...
        <div className='flex justify-between'>
            ...
            <Modal open={addMemModal} title='Thêm thành viên' onCancel={() => {
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input value={memberEmail} onChange={(e) => setMemberEmail(e.target.value)} type="text" className="border border-gray-300 rounded-md p-3 outline-none" />
                    <p className="text-red-500 text-sm">{addMemError.email}</p>
                </div>
                <div className="flex flex-col gap-2">
                    <label className="font-medium">Vai trò</label>
                    <input value={memberRole} onChange={(e) => setMemberRole(e.target.value)} type="text" className="border border-gray-300 rounded-md p-3 outline-none" />
